...
export const Footer = () => {
    return (
        <footer className="relative bg-gradient-to-br from-violet-600 via-violet-500 to-violet-500 pt-12 pb-8 overflow-hidden">
            {/* Background patterns */}
            ...
            <div className="container relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
                    <div className="group">
                        ...
                        <p className="text-gray-600 leading-relaxed mb-8">
                            Helping startups transform ideas into reality with
                ...
                <div className="mt-24 pt-8 border-t text-gray-300  text-sm border-black/10 flex justify-between items-center">
                    <p className="font-medium">
                        © {new Date().getFullYear()} Chillbion. All rights
                        reserved.
                    </p>
                    <p>
