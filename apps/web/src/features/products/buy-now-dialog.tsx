...
export const BuyNowDialog = ({ product }: BuyNowDialogProps) => {
    ...
    const deliveryCharge =
        deliveryOptions.find((opt) => opt.value === deliveryOption)?.price || 0;
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="lg:max-w-3xl">
                ...
                <DialogContainer className="space-y-6 max-h-[75vh] mb-0">
                    {/* Product Details */}
                    <div className="flex flex-wrap justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <p className="text-lg pr-4 text-right min-w-[160px] md:min-w-[200px]">
