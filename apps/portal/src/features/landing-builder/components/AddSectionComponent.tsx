...
import { allComponentsTypeOptions } from "@repo/ui/features/data";
import type { Component } from "@repo/ui/type/index";
import { EComponentType, Section } from "@repo/ui/type/index";
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                ...
                <div className="h-[73dvh] w-full overflow-y-auto">
                    {allStep[step]}
                </div>
