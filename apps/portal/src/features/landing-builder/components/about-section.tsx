...
const ABOUT_ACCORDION_VALUE = "about-section";
...
export const AboutSection = () => {
    ...
    return (
        <Accordion type="single" collapsible className="bg-card rounded-lg border">
            <AccordionItem value={ABOUT_ACCORDION_VALUE} className="border-0">
                <AccordionTrigger className="px-4 py-4 hover:no-underline lg:px-6 lg:py-5">
                    <div className="flex flex-col items-start gap-0.5 text-left">
                        <span className="text-lg font-semibold">আমাদের সার্ভিস কেন সেরা? (About / Why us)</span>
