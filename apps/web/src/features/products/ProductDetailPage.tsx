    ...
    <div className="container mx-auto px-4 py-6 md:px-6 lg:py-12">
      ...
      <nav className="mb-6 text-sm text-muted-foreground">
        <ol className="flex items-center space-x-1">
          ...
          <li className="font-medium text-foreground">
            Water Drop BB Foundation - Lightweight, Oil-Free Formula with SPF 15
          </li>
        </ol>
      </nav>
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_350px]">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="grid gap-6">
              <h1 className="text-2xl font-bold md:text-3xl">
                Water Drop BB Foundation - Lightweight, Oil-Free Formula with
                SPF 15
              </h1>
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-red-600">৳400</span>
              ...
              <div className="text-sm text-muted-foreground">
                <p>
                  <span className="font-medium text-foreground">Total:</span> 20
                </p>
                <p>
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Achieve a flawless, radiant look with the Water Drop BB
                Foundation, the ultimate multi-tasking beauty essential designed
                to simplify your skincare and makeup routine. This...
              </p>
        ...
        <div className="flex flex-col gap-6">
          {/* Related Products */}
          <Card>
            <h2 className="text-xl pl-4 font-bold">Related Products</h2>
            <div className="flex  gap-4 pl-4">
              ...
              <div className="grid gap-1">
                ...
                <p className="text-lg font-bold text-red-600">৳400</p>
                <div className="flex items-center gap-0.5">
