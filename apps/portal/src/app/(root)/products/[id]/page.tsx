...
const EditProduct = () => {
    ...
    const [savingVariants, setSavingVariants] = useState<Set<number>>(
        new Set()
    );
                        ...
                        <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        পণ্যের ভারিয়েন্ট যেমন সাইজ, কালচার
                                        ইত্যাদি
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                        ...
                        <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                            <Card className="overflow-hidden">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        পণ্যের ছবি যেমন প্রথম ছবি, দ্বিতীয় ছবি
                                        ইত্যাদি
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
