        ...
        components: [
            {
                ...
                description: "Banner1 is a component that displays a banner with a title, description, and an image.",
                fieldLabel: {
            ...
            },
            {
                ...
                description: "Banner2 is a component that displays a banner with a title, description, and an image.",
            },
            {
                name: "Banner03",
                component: Banner03,
                defaultValue: banner03Data,
                description: "Banner3 is a component that displays a banner with a title, description, and an image.",
            },
            {
                name: "Banner04",
                component: Banner04,
                defaultValue: banner04Data,
                description: "Banner4 is a component that displays a banner with a title, description, and an image.",
            },
            {
                name: "Banner05",
                component: Banner05,
                defaultValue: banner05Data,
                description: "Banner5 is a component that displays a banner with a title, description, and an image.",
            },
            {
                name: "Banner06",
                component: Banner06,
                defaultValue: banner06Data,
                description: "Banner6 is a component that displays a banner with a title, description, and an image.",
            },
        ],
    },
    {
        ...
        components: [
            {
                ...
                description: "About1 is a component that displays a about with a title, description, and an image.",
            },
        ],
    },
    {
        ...
        components: [
            {
                ...
                description: "Footer1 is a component that displays a footer with a title, description, and an image.",
            },
        ],
    },
];
...
export const allComponentsTypeOptions = [
    {
        id: "banner",
        title: "Banner",
        description: "A prominent strip that highlights important announcements or promotions.",
        color: "bg-purple-100",
    ...
    },
    {
        id: "features",
        title: "Features",
        description: "Highlight the key features and benefits of your product or service.",
        color: "bg-red-100",
    ...
    },
    {
        id: "testimonials",
        title: "Testimonials",
        description: "Social proof from satisfied customers to build trust with potential customers.",
        color: "bg-indigo-100",
    ...
    },
    {
        id: "faq",
        title: "FAQ",
        description: "Answers to common questions to help users make informed decisions.",
        color: "bg-teal-100",
    ...
    },
    {
        id: "cta",
        title: "CTA",
        description: "Call-to-action sections that encourage users to take the next step.",
        color: "bg-orange-100",
    ...
    },
    {
        id: "footer",
        title: "Footer",
        description: "The bottom section of your website with important links and information.",
        color: "bg-cyan-100",
