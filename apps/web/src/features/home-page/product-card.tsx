  ...
  return (
    ...
    >
      <div className="relative ">
        ...
        <Image
          src="http://multi-media-server.naimurrhman.com/uploads/img/1745580373811-76572101.jpg"
      ...
      <div className="p-4 border-t ">
        <h3 className="text-sm  bg-primary text-white px-2 py-1 rounded-sm inline-block">
          {product.name}
        </h3>
