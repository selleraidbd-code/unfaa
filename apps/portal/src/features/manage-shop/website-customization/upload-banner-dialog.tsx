  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await updateCoreTheme({
        id: themeId,
        payload: {
          bannerImg: [...bannerImg, ...uploadedMedia.map((media) => media.url)],
        },
      })
        .unwrap()
        .then(() => {
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      <DialogContent className="lg:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>
            N.B: Recommended banner size is 1600x500 pixels. Max file size is
            4MB.
          </DialogDescription>
        </DialogHeader>
          ...
          >
            ...
            <div className="space-y-1.5 text-center">
              <p className="text-foreground/80 text-sm font-medium">
                Choose images or Drag & drop them here. Files must be in JPEG,
                JPG or PNG format
              </p>
