...
import EnhancedFormBuilder from "@/features/landing-builder/form/enhanced-form-builder";
...
const ComponentFormModal = (props: Props) => {
  ...
  const defaultFormValue = useAppSelector(
    (state) => state.landingPage.landingPageSections[props.index]?.componentData
  );
