...
export const FileModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="flex h-[90vh] w-[80vw] flex-col">
        <DialogHeader>
            ...
            <div className="h-full flex-1 lg:overflow-auto lg:rounded-md lg:border lg:p-4">
              {!isLoading && filteredFiles.length === 0 ? (
                ...
                <div className="@container space-y-4">
                  ...
                  <div
                    className={cn(
                      "grid grid-cols-2 select-none @sm:grid-cols-3 @sm:gap-2 @md:grid-cols-3 @lg:grid-cols-4 @2xl:grid-cols-4 @3xl:grid-cols-5 @3xl:gap-3 @5xl:grid-cols-7"
                    )}
                  >
                    {isLoading
