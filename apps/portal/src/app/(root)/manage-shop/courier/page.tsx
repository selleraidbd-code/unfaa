...
const DeliverySupport = () => {
  ...
  const [isIntegrateServicesOpen, setIsIntegrateServicesOpen] = useState(true);
    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">
            Please provide your Steadfast credentials to integrate Steadfast
          </p>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <span className="text-sm font-bold text-white">REDX</span>
          </Button>
    ...
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">
            Please provide your Paperfly credentials to integrate Paperfly
          </p>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
