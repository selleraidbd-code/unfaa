...
export const InvoiceModal = ({ receiptDialogOpen, setReceiptDialogOpen, orderNumber }: InvoiceModalProps) => {
    ...
    return (
        <Dialog open={receiptDialogOpen} onOpenChange={setReceiptDialogOpen}>
            <DialogContent>
                ...
                <div ref={targetRef} className="mx-auto w-[595px] bg-[#ffffff] font-sans text-[#0A1D5C]">
                    {/* Header */}
                    <div className="relative">
                        <div className="h-[200px] overflow-hidden rounded-b-[60px] bg-[#0A1D5C]">
                            ...
                            <div className="absolute top-6 right-8 z-20 space-y-1 text-sm text-[#ffffff]">
                                ...
                                <p>📍 Ebrahim Electric Market-124, BCC Road, Nawabpur Dhaka-1100, Bangladesh</p>
                            </div>
                        </div>
                    </div>
