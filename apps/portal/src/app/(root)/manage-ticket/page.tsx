...
import { UpdateTicketDialog } from "@/features/manage-ticket/update-ticket-dialog";
    ...
    return (
        <>
            <div className="space-y-4">
                <div>
                    <h2 className="text-2xl font-semibold tracking-tight">Manage Tickets</h2>
                    <p className="text-muted-foreground">View and manage all tickets from users.</p>
                </div>
